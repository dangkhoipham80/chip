      ...
      <div className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex justify-between items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="text-[10px] text-white/80 font-semibold ml-1">ĐIỂM SỐ</div>
          </div>
          ...
          <div className="flex-1 flex justify-end items-center gap-2">
            <button
              onClick={onToggleBGM}
              className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm border border-white/40 hover:bg-white/30 hover:scale-110 transition-all flex items-center justify-center text-lg shadow-lg"
            ...
            <div className="hidden md:flex gap-2">
              <div className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg px-2 py-1 shadow-md flex items-center gap-2">
                <div className="text-[10px] text-white font-semibold">BGM</div>
                <input
                  type="range"
                  min="0"
                  max="1"
              ...
              <div className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg px-2 py-1 shadow-md flex items-center gap-2">
                <div className="text-[10px] text-white font-semibold">SFX</div>
                <input
                  type="range"
                  min="0"
                  max="1"
